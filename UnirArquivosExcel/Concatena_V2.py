...
# Define o caminho da pasta 'resultado' e do arquivo de saída
pasta_resultado = pasta_atual / 'resultado'
arquivo_saida = pasta_resultado / 'arquivo_saida.xlsx'

# Verifica se a pasta 'resultado' existe, se não, cria
if not pasta_resultado.exists():
    try:
        pasta_resultado.mkdir(parents=True)
        print(f"Pasta 'resultado' criada com sucesso: {pasta_resultado}")
    except Exception as e:
        print(f"Erro ao criar a pasta 'resultado': {e}")
